...
def streamlit_config():
    st.set_page_config(layout="wide", page_title="Zomato")  
    # tab1, tab2, tab3 = st.tabs(['Visao Gerencial', 'Visão Tática', 'Visão Geográfica'])
    ## sidebar
    # image = Image.open('/repos/Zomato Restaurants/images/logo.png')
    image = Image.open('logo.png')
    st.sidebar.image( image, width=250 )
    
    st.sidebar.markdown('<center><h1> Zomato </h1> </center>', unsafe_allow_html=True)
    st.sidebar.markdown('## Here you find the best restaurants')
    st.sidebar.markdown("""---""")

    st.sidebar.markdown("""[![Repo](https://content.linkedin.com/content/dam/me/business/en-us/amp/brand-site/v2/bg/LI-Bug.svg.original.svg)](https://www.linkedin.com/in/leonardorose/) <b> Leonardo Rose </b>""", unsafe_allow_html=True)
    st.sidebar.markdown("""---""")
...
st.markdown(
    ...
    Neste dashboard foram criados 3 visões para auxilio na tomada de decisão do usuário:
      - <b>Company</b> - dados gerais da empresa
      - <b>Restaurants</b> - dados sobre os restaurantes
      - <b>Geographic View</b> - visão geográfica com informações dos restaurantes
...
st.markdown(
    ...
    In this dashboard, 3 views were created:
      ...
      - <b>Restaurants</b> - restaurants general information
      - <b>Geographic View</b> - geographic view with restaurants informations
