...
def first_container(df):
    st.markdown("<h1 style='text-align: center; color: black;'>Restaurants World Map</h1>", unsafe_allow_html=True)
    ...
    st.markdown('<center>Choose the identifier on the left side panel</center>', unsafe_allow_html=True)    
